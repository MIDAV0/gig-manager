...
COPY public.act_gig (actid, gigid, actfee, ontime, duration) FROM stdin;
...
5	4	30000	2020-04-06 18:00:00	30
5	3	13000	2017-09-07 19:00:00	30
5	3	31000	2017-09-07 19:35:00	40
1	5	23000	2019-04-08 19:30:00	50
\.


COPY public.gig (gigid, venueid, gigtitle, gigdate, gigstatus) FROM stdin;
